...
def get_df_from_sql(SSH_requiered, query,key_path,db='datawarehouse'):   #for getting a datafarame as a result
    if db == 'datawarehouse' :
...
def get_conn(SSH_requiered,key_path,db='datawarehouse'):   #for getting a conn as a result
