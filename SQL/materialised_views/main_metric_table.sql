-- View: public.main_metric_table

-- DROP MATERIALIZED VIEW IF EXISTS public.main_metric_table;

CREATE MATERIALIZED VIEW IF NOT EXISTS public.main_metric_table
...
ALTER TABLE IF EXISTS public.main_metric_table
    OWNER TO postgres;


CREATE UNIQUE INDEX main_metric_table_2_pkey
    ON public.main_metric_table USING btree
    (key COLLATE pg_catalog."default")
    TABLESPACE pg_default;
CREATE UNIQUE INDEX main_metric_table_pkey
    ON public.main_metric_table USING btree
    (key COLLATE pg_catalog."default")
    TABLESPACE pg_default;