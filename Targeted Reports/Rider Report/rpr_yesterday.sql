...
select
    ...
    from base
    where 1=1
    and lower(hub) not like '%frh%'
    and lower(hub) not like '%franchise%'
    group by 
        shipping_city
    ,   hub
    ,   rider_id
...
, final2 as (
    ...
    from final 
    left join application_db.rider on application_db.rider.locus_rider_id = final.rider_id
    where 1=1
    -- and today_fake >1 
